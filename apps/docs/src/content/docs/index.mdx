...
<CardGrid staggered>
  ...
  <Card title="Backend Ready" icon="add-document">
    Native support for Node.js libraries, CLI tools, and **Fastify** (coming soon).
  </Card>
</CardGrid>
...
3. Generate Your First Package
    Navigate into your project and add a module:
...
Use `stack g <name>` to generate different architecture patterns:
...
| Fastify | *(Coming Soon)* High-performance backend API scaffolding |
...
- `apps/*` — Deployment targets (Vite apps, CLIs, etc.)
